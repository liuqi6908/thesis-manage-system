    ...
    case 6:
      ...
      setTimeout(() => {
        if (isFullscreen.value) {
          ...
          tagsViews[6].text = $t("buttons.wholeExitFullScreen");
        } else {
          tagsViews[6].icon = Fullscreen;
          tagsViews[6].text = $t("buttons.wholeFullScreen");
        }
      }, 100);
      break;
    case 7:
      ...
      setTimeout(() => {
        if (pureSetting.hiddenSideBar) {
          ...
          tagsViews[7].text = $t("buttons.contentExitFullScreen");
        } else {
          tagsViews[7].icon = Fullscreen;
          tagsViews[7].text = $t("buttons.contentFullScreen");
        }
      }, 100);
      break;
  }
